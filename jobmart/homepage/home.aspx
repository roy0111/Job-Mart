          ...
          <div class="margin">
            <div class="s-12 m-12 l-4 margin-m-bottom">
              <div class="padding-2x block-bordered">
                <i class="icon-sli-compass  icon3x text-dark center margin-bottom-30"></i>
                <h2 class="text-thin">Search millions of jobs</h2>
                <p class="margin-bottom-30"> You've got plenty of options. Plus, we'll send an alert when a good fit for you is posted.</p>
            ...
            <div class="s-12 m-12 l-4 margin-m-bottom">
              <div class="padding-2x block-bordered">
                ...
                <h2 class="text-thin">Get discovered</h2>
                <p class="margin-bottom-30">Create an account and upload your resume to be found by the recruiters who search databases every day.</p>
                <!-- <a class="button button-dark-stroke text-size-12" href="/">GET MORE INFO</a> -->
              </div>
            </div>
            <div class="s-12 m-12 l-4 margin-m-bottom">
              <div class="padding-2x block-bordered">
                <i class="icon-sli-badge  icon3x text-dark center margin-bottom-30"></i>
                <h2 class="text-thin">Be a better candidate</h2>
                <p class="margin-bottom-30">We've got your back. Our career advice, resume services and education partners give you a leg up in the job search.</p>
              <!--   <a class="button button-dark-stroke text-size-12" href="/">Keep Connect to Us</a> -->
              </div>
            </div>
          </div>
        </div>
